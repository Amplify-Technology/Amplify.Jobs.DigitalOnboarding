...
namespace Amplify.Jobs.DigitalOnboarding.Onboarding.Models.PershingModels
{
    ...
    {
        public AccountHolderTypeInfo? accountHolderType { get; set; }
        public class AccountHolderTypeInfo
        {
            ...
            public string? participantProxyAuthorityIndicator { get; set; }
            public string? gender { get; set; }
            public string? maritalStatus { get; set; }
            public string? discretionIndicator { get; set; }
            ...
            public string? benePercentAllocation { get; set; }
            public string? holderRelCode { get; set; }
            ...
            public string? participantStatementIndicator { get; set; }
            public string? participantConfirmIndicator { get; set; }
